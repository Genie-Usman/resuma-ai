                            ...
                            {/* Institution */}
                                <div className="flex flex-col">
                                    ...
                                    <input
                                        ...
                                        onChange={({ target }) =>
                                            updateArrayItem("education", index, "institution", target.value)
                                        }
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <input
                                        ...
                                        onChange={({ target }) =>
                                            updateArrayItem("education", index, "studyType", target.value)
                                        }
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <input
                                        ...
                                        value={item.area || ""}
                                        onChange={({ target }) =>
                                            updateArrayItem("education", index, "area", target.value)
                                        }
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <input
                                        ...
                                        value={item.score || ""}
                                        onChange={({ target }) =>
                                            updateArrayItem("education", index, "score", target.value)
                                        }
                                        placeholder="9.2 GPA"
                                        className="border border-gray-300 rounded px-3 py-2 w-full"
                                    />
                                ...
                                <div className="flex flex-col col-span-2">
                                    ...
                                    <input
                                        ...
                                        value={item.date || ""}
                                        onChange={({ target }) =>
                                            updateArrayItem("education", index, "date", target.value)
                                        }
                                ...
                                <div className="flex flex-col md:col-span-2">
                                    <SummarySectionForm
                                        ...
                                        updateContent={(newSummary) =>
                                            updateArrayItem("education", index, "summary", newSummary)
                                        }
                                    />
                                </div>
                            </div>
