...
const InterestForm = ({ interests, updateArrayItem, addArrayItem, removeArrayItem, setResumeData }) => {
    ...
    return (
        <div className="px-5 pt-5">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-900">Interests</h2>
            ...
            <div className="mt-4 flex flex-col gap-4 mb-3">
                {interests.map((item, index) => (
                    <div key={item.id || index} className="relative border border-gray-200/50 p-4 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {/* Keywords */}
                            <div className="flex flex-col">
                                <label className="mb-1 font-semibold text-sm">Keywords</label>
                                <input
                                    type="text"
                                    value={item.keywords || ""}
                                    onChange={({ target }) =>
                                        updateArrayItem( index, "keywords", target.value)
                                    }
                ...
                >
                    <div className="flex flex-row items-center justify-center gap-1">
                        ...
                        <span className="py-0.5 text-base">Add Another Interest</span>
                    </div>
                </button>
            </div>
        </div>
