...
const Button = ({ children, onClick, disabled }) => {
    return (
        <button onClick={onClick}
            disabled={disabled}
            className="group relative bg-purple-500 rounded-sm mb-5 overflow-hidden cursor-pointer">
            ...
            >
                <span
                    className="block z-0 h-full w-12 blur-xl -translate-x-1/2 rounded-sm"
                    style={{
            ...
            {/* Content */}
            <span className="flex items-center justify-center gap-1 relative z-[1] bg-purple-200 rounded-sm py-2 px-4 pl-2 w-full">
                <span className="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
                    ...
                    >
                        ...
                        />
                        <defs>
                            <linearGradient id="paint0" x1="-0.5" y1="9" x2="15.5" y2="-1.5" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#7A69F9" />
                                <stop offset="0.575" stopColor="#F26378" />
                                <stop offset="1" stopColor="#F5833F" />
                            </linearGradient>
                            <linearGradient id="paint1" x1="-0.5" y1="9" x2="15.5" y2="-1.5" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#7A69F9" />
                                <stop offset="0.575" stopColor="#F26378" />
                                <stop offset="1" stopColor="#F5833F" />
                            </linearGradient>
                    ...
                    {/* Shine effect */}
                    <span
                        className="rounded-sm w-15 h-15 absolute opacity-40 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-md"
                        style={{
                ...
                {/* Button Text */}
                <span className="text-purple-700 bg-clip-text text-base font-bold">
                    {children}
                </span>
            </span>
        </button>
